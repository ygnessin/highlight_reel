...
mkdir -p ~/Library/Application\ Support/Sublime\ Text\ 3/Packages/Rails && cp Ruby\ on\ Rails.tmLanguage ~/Library/Application\ Support/Sublime\ Text\ 3/Packages/Rails/Ruby\ on\ Rails-custom.tmLanguage
